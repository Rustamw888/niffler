...
//      authUserDAO.createUser(user);
      NifflerUser9Repository userRepository = new NifflerUser9Repository();
...
//    authUserDAO.deleteUser(user);
    NifflerUser9Repository userRepository = context.getStore(RANDOM_USER_REPOSITORY_NAMESPACE).get("userRepository", NifflerUser9Repository.class);
