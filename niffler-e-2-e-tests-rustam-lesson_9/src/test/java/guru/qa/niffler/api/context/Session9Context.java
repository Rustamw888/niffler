...
public class Session9Context {

  private final Map<String, String> storage;
  private static final ThreadLocal<Session9Context> INSTANCE = ThreadLocal.withInitial(
      Session9Context::new);
  ...
  private Session9Context() {
    storage = new HashMap<>();
  }

  public static Session9Context getInstance() {
    return INSTANCE.get();
  }
