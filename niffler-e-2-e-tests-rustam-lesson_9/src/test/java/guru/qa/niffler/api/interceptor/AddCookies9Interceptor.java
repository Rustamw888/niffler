...
public class AddCookies9Interceptor implements Interceptor {
  ...
  public Response intercept(Chain chain) throws IOException {
    ...
    String cookieXsrf = cookie9Context.getCookie("XSRF-TOKEN");
    String jsessionId = cookie9Context.getCookie("JSESSIONID");
